 ...
 * It measures the similarity of two melodies based on the absolute difference in
 * frequencies of equal NGrams in two melodies
 */
    ...
    public double compareTo(AMelody midiMelody1, AMelody midiMelody2) {
        ...
        for (INGram n : firstMelodyNGrams) {
            if (secondMelodyNGrams.contains(n)) {
                ...
                nGramFrequencyDifferenceSum += Math.abs(n.getFrequency()
                        - theNGram.getFrequency());
            } else {
