...
public class Test_Melody{
	File file = new File(
			"P2 Kode/src/a307a/midilib//parser//Mester-Jakob.mid");
	...
	//TODO: Implementer test der sørger for den højeste tone bliver valgt i
	// melodien.
	@Test
	void test3() throws InvalidMidiDataException{
		...
		reader.getNotesOnChannel(0)
				.forEach(n->System.err.println(n.getPitch()));
	}
